...
- [Error Handling](#error-handling)
  - [Always Check Errors](#always-check-errors)
  - [Wrap Errors with Context](#wrap-errors-with-context)
  - [Use Custom Errors for Domain Logic](#use-custom-errors-for-domain-logic)
- [Concurrency](#concurrency)
  - [Use Channels for Communication](#use-channels-for-communication)
  - [Always Close Channels](#always-close-channels)
  - [Use Context for Cancellation](#use-context-for-cancellation)
  - [Avoid Goroutine Leaks](#avoid-goroutine-leaks)
- [Performance Optimization](#performance-optimization)
  - [Use Pointers for Large Structs](#use-pointers-for-large-structs)
  - [Preallocate Slices](#preallocate-slices)
  - [Use strings.Builder for String Concatenation](#use-stringsbuilder-for-string-concatenation)
  - [Use sync.Pool for Frequently Allocated Objects](#use-syncpool-for-frequently-allocated-objects)
- [Memory Management](#memory-management)
  - [Avoid Memory Leaks](#avoid-memory-leaks)
  - [Use defer for Resource Cleanup](#use-defer-for-resource-cleanup)
- [Interface Design](#interface-design)
  - [Accept Interfaces, Return Structs](#accept-interfaces-return-structs)
  - [Keep Interfaces Small](#keep-interfaces-small)
- [Testing](#testing)
  - [Write Table-Driven Tests](#write-table-driven-tests)
  - [Use Test Helpers](#use-test-helpers)
- [Common Pitfalls](#common-pitfalls)
  - [1. Range Loop Variable Capture](#1-range-loop-variable-capture)
  - [2. Slice Append Gotcha](#2-slice-append-gotcha)
  - [3. Map Concurrent Access](#3-map-concurrent-access)
  - [4. Nil Interface vs Nil Value](#4-nil-interface-vs-nil-value)
  - [5. Defer in Loops](#5-defer-in-loops)
- [Code Style](#code-style)
  - [Use gofmt](#use-gofmt)
  - [Use golint](#use-golint)
  - [Use go vet](#use-go-vet)
  - [Use staticcheck](#use-staticcheck)
...
- [Advanced Go Patterns](#advanced-go-patterns)
...
- [Performance Optimization](#performance-optimization-1)
  ...
  - [Map Preallocation](#map-preallocation)
  - [Avoid Unnecessary Allocations](#avoid-unnecessary-allocations)
  - [Use Sync.Pool for Temporary Objects](#use-syncpool-for-temporary-objects)
