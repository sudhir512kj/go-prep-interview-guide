...
- [Data Structures Cheat Sheet](#data-structures-cheat-sheet)
...
- [Common Pitfalls](#common-pitfalls)
  - [1. Loop Variable Capture](#1-loop-variable-capture)
  - [2. Nil Interface](#2-nil-interface)
  - [3. Slice Append](#3-slice-append)
  - [4. Map Concurrent Access](#4-map-concurrent-access)
  - [5. Defer in Loop](#5-defer-in-loop)
