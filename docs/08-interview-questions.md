...
- [Basic Concepts](#basic-concepts)
  - [1. What is Go? What are its key features?](#1-what-is-go-what-are-its-key-features)
  - [2. What is the difference between var and :=?](#2-what-is-the-difference-between-var-and-)
  - [3. What are goroutines?](#3-what-are-goroutines)
  - [4. What is a channel?](#4-what-is-a-channel)
  - [5. What is the difference between buffered and unbuffered channels?](#5-what-is-the-difference-between-buffered-and-unbuffered-channels)
- [Intermediate Concepts](#intermediate-concepts)
  - [6. Explain defer, panic, and recover](#6-explain-defer-panic-and-recover)
  - [7. What is the difference between array and slice?](#7-what-is-the-difference-between-array-and-slice)
  - [8. How does Go handle memory management?](#8-how-does-go-handle-memory-management)
  - [9. What is an interface in Go?](#9-what-is-an-interface-in-go)
  - [10. What is the empty interface?](#10-what-is-the-empty-interface)
- [Advanced Concepts](#advanced-concepts)
  - [11. Explain the select statement](#11-explain-the-select-statement)
  - [12. What is a mutex? When would you use it?](#12-what-is-a-mutex-when-would-you-use-it)
  - [13. What is the difference between Mutex and RWMutex?](#13-what-is-the-difference-between-mutex-and-rwmutex)
  - [14. What is a WaitGroup?](#14-what-is-a-waitgroup)
  - [15. Explain context package](#15-explain-context-package)
- [Coding Problems](#coding-problems)
  - [16. Reverse a string](#16-reverse-a-string)
  - [17. Check if a string is a palindrome](#17-check-if-a-string-is-a-palindrome)
  - [18. Find duplicate in array](#18-find-duplicate-in-array)
  - [19. Implement a stack](#19-implement-a-stack)
  - [20. Implement a queue](#20-implement-a-queue)
  - [21. Merge two sorted arrays](#21-merge-two-sorted-arrays)
  - [22. Find missing number in array](#22-find-missing-number-in-array)
  - [23. Two Sum problem](#23-two-sum-problem)
  - [24. Valid Parentheses](#24-valid-parentheses)
  - [25. Longest substring without repeating characters](#25-longest-substring-without-repeating-characters)
- [Scenario-Based Questions](#scenario-based-questions)
  - [26. How would you implement a rate limiter?](#26-how-would-you-implement-a-rate-limiter)
  - [27. How would you implement a worker pool?](#27-how-would-you-implement-a-worker-pool)
  - [28. How would you implement a cache with expiration?](#28-how-would-you-implement-a-cache-with-expiration)
  - [29. How would you handle graceful shutdown?](#29-how-would-you-handle-graceful-shutdown)
  - [30. How would you implement a singleton pattern?](#30-how-would-you-implement-a-singleton-pattern)
- [Conceptual Questions](#conceptual-questions)
  - [31. What is the difference between concurrency and parallelism?](#31-what-is-the-difference-between-concurrency-and-parallelism)
  - [32. What is a race condition? How do you prevent it?](#32-what-is-a-race-condition-how-do-you-prevent-it)
  - [33. What is the difference between make and new?](#33-what-is-the-difference-between-make-and-new)
  - [34. What is method receiver? Difference between value and pointer receiver?](#34-what-is-method-receiver-difference-between-value-and-pointer-receiver)
  - [35. What is type assertion?](#35-what-is-type-assertion)
  - [36. What is type switch?](#36-what-is-type-switch)
  - [37. What are Go modules?](#37-what-are-go-modules)
  - [38. What is the init function?](#38-what-is-the-init-function)
  - [39. What is a closure?](#39-what-is-a-closure)
  - [40. What is the difference between len() and cap() for slices?](#40-what-is-the-difference-between-len-and-cap-for-slices)
- [Deep Dive Questions](#deep-dive-questions)
  - [41. Explain Go's memory model](#41-explain-gos-memory-model)
  - [42. What is escape analysis?](#42-what-is-escape-analysis)
  - [43. Explain Go's garbage collector](#43-explain-gos-garbage-collector)
  - [44. What are build tags?](#44-what-are-build-tags)
  - [45. Explain Go modules and versioning](#45-explain-go-modules-and-versioning)
- [Advanced Coding Problems](#advanced-coding-problems)
  - [46. Implement LRU Cache](#46-implement-lru-cache)
  - [47. Implement Thread-Safe Counter with Timeout](#47-implement-thread-safe-counter-with-timeout)
  - [48. Implement Concurrent Map with Sharding](#48-implement-concurrent-map-with-sharding)
  - [49. Implement Semaphore](#49-implement-semaphore)
  - [50. Implement Circuit Breaker](#50-implement-circuit-breaker)
- [System Design Questions](#system-design-questions)
  - [51. Design a URL Shortener](#51-design-a-url-shortener)
  - [52. Design a Rate Limiter](#52-design-a-rate-limiter)
- [Tricky Questions](#tricky-questions)
  - [53. What's the output?](#53-whats-the-output)
  - [54. What's wrong with this code?](#54-whats-wrong-with-this-code)
  - [55. What's the difference?](#55-whats-the-difference)
  - [56. Explain the output](#56-explain-the-output)
  - [57. What happens here?](#57-what-happens-here)
- [Performance Questions](#performance-questions)
  - [58. Which is faster and why?](#58-which-is-faster-and-why)
  - [59. Optimize this code](#59-optimize-this-code)
  - [60. Memory leak?](#60-memory-leak)
