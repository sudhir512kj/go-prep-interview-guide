...
- [Testing with Setup and Teardown](#testing-with-setup-and-teardown)
  - [Test Main](#test-main)
  - [Setup and Teardown per Test](#setup-and-teardown-per-test)
- [Mocking](#mocking)
  - [Interface-Based Mocking](#interface-based-mocking)
  - [HTTP Mocking](#http-mocking)
- [Benchmarking](#benchmarking)
  - [Basic Benchmark](#basic-benchmark)
  - [Benchmark with Setup](#benchmark-with-setup)
  - [Parallel Benchmarks](#parallel-benchmarks)
  - [Sub-benchmarks](#sub-benchmarks)
- [Testing with Testify](#testing-with-testify)
  - [Assertions](#assertions)
  - [Require (Stops on Failure)](#require-stops-on-failure)
  - [Mock with Testify](#mock-with-testify)
...
- [Testing Best Practices](#testing-best-practices)
  ...
  - [4. Use Test Fixtures](#4-use-test-fixtures)
  - [5. Test Error Cases](#5-test-error-cases)
- [Running Tests](#running-tests)
- [Testing Philosophy in Go](#testing-philosophy-in-go)
...
- [Integration Testing](#integration-testing-1)
  ...
  - [Environment-Based Tests](#environment-based-tests)
