...
- [Easy Level](#easy-level)
  ...
  - [2. Find Maximum in Array](#2-find-maximum-in-array)
  - [3. Count Vowels](#3-count-vowels)
  - [4. Fibonacci Number](#4-fibonacci-number)
  - [5. Check Palindrome](#5-check-palindrome)
- [Medium Level](#medium-level)
  - [6. Two Sum](#6-two-sum)
  - [7. Valid Parentheses](#7-valid-parentheses)
  - [8. Merge Sorted Arrays](#8-merge-sorted-arrays)
  - [9. Find Duplicate](#9-find-duplicate)
  - [10. Longest Substring Without Repeating Characters](#10-longest-substring-without-repeating-characters)
- [Hard Level](#hard-level)
  - [11. LRU Cache](#11-lru-cache)
  - [12. Median of Two Sorted Arrays](#12-median-of-two-sorted-arrays)
  - [13. Trapping Rain Water](#13-trapping-rain-water)
  - [14. Word Ladder](#14-word-ladder)
  - [15. Serialize and Deserialize Binary Tree](#15-serialize-and-deserialize-binary-tree)
- [Concurrency Exercises](#concurrency-exercises)
  - [16. Parallel Sum](#16-parallel-sum)
  - [17. Producer-Consumer](#17-producer-consumer)
  - [18. Concurrent Web Scraper](#18-concurrent-web-scraper)
  - [19. Rate Limited API Client](#19-rate-limited-api-client)
  - [20. Concurrent Map Reduce](#20-concurrent-map-reduce)
- [System Design Exercises](#system-design-exercises)
  - [21. Design URL Shortener](#21-design-url-shortener)
  - [22. Design Rate Limiter](#22-design-rate-limiter)
  - [23. Design Cache System](#23-design-cache-system)
  - [24. Design Task Scheduler](#24-design-task-scheduler)
  - [25. Design Message Queue](#25-design-message-queue)
- [Testing Exercises](#testing-exercises)
  - [26. Write Tests for Calculator](#26-write-tests-for-calculator)
  - [27. Write Benchmarks](#27-write-benchmarks)
  - [28. Mock HTTP Client](#28-mock-http-client)
- [Real-World Scenarios](#real-world-scenarios)
  - [29. Log Aggregator](#29-log-aggregator)
  - [30. File Processor](#30-file-processor)
- [Challenge Problems](#challenge-problems)
  - [31. Implement sync.Map](#31-implement-syncmap)
  - [32. Implement Context](#32-implement-context)
  - [33. Implement Worker Pool](#33-implement-worker-pool)
  - [34. Implement Circuit Breaker](#34-implement-circuit-breaker)
  - [35. Implement Retry Mechanism](#35-implement-retry-mechanism)
...
- [Practice Schedule](#practice-schedule)
  ...
  - [Week 4: Polish](#week-4-polish)
- [Resources for More Practice](#resources-for-more-practice)
